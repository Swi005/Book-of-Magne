...
tests = [testAssoc, testAddComm, testAddID, testAddInv, testMultAssoc, testMultID, testLDist, testRDist]
        ...
        \subsection{Signature}
            A signature contains a list of types and operations on those types. The list of operations describes the allowed input type and expected output tupe.
    ...
    \section{Language Standards}
       ...
       \gls{SLE} has many applications within software engineering like;
        ...
        \subsubsection{Backus-Naur Form}
            \gls{BNF} is format for describing context-free grammar. We use it to describe the syntax of languages. Although it is probably not part of the curiculum
